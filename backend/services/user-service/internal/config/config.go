...
func (cfg Config) String() string {
	return fmt.Sprintf("grpc=%s reflection=%t db_max_open=%d validation_phone_region=%s events_enabled=%t events_provider=%s outbox_worker=%t", cfg.GRPC.Address, cfg.GRPC.Reflection, cfg.Database.MaxOpenConns, cfg.Validation.PhoneRegion, cfg.Events.Enabled, cfg.Events.Provider, cfg.OutboxWorker.Enabled)
}
