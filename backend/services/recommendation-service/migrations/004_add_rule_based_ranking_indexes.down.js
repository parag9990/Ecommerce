...
dropIndexIfExists("product_features", "idx_product_features_rule_based_global");
dropIndexIfExists("product_features", "idx_product_features_rule_based_category");
dropIndexIfExists("product_features", "idx_product_features_rule_based_seller");
